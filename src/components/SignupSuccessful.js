                ...
                <div className="col-md-10 mx-auto mt-5">
                    <div className="card shad mt-5">
                        <div className="card-body ml-3 my-4 text-center">
                            ...
                            <h5 className="mt-4"><a className="blackLinks" href="/#">Click here to go to login page</a></h5>
                            <h5 className="mt-n1">or</h5>
                            <h5 className="mt-n1"><a className="blackLinks" href="/#">Return to home page</a></h5>
                        </div>
                    </div>
                </div>
            </div>
